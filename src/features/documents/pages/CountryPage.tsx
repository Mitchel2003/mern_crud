import TableCountrySection from '@/features/documents/sections/country/TableCountrySection'
import FormCountrySection from '@/features/documents/sections/country/FormCountrySection'
        ...
        <main className="container p-2 sm:p-4">
          <Tabs value={tab} onValueChange={handle}>
            ...
            <TabsContent value="table">
              <TableCountrySection theme={theme} onChange={() => handle('form')} params={params} />
            </TabsContent>
            <TabsContent value="form">
              <Card className={cn('relative w-full', theme === 'dark' ? 'bg-zinc-800' : 'bg-white')}>
                <FormCountrySection id={id} theme={theme} onChange={() => handle('table')} />
              </Card>
            </TabsContent>
          </Tabs>
        </main>
