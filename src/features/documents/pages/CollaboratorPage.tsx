import TableCollaboratorSection from '@/features/documents/sections/reusables/user/TableUserSection'
import FormCollaboratorSection from '@/features/documents/sections/reusables/user/FormUserSection'
        ...
        <main className="container p-2 sm:p-4">
          <Tabs value={tab} onValueChange={handle}>
            ...
            <TabsContent value="table">
              <TableCollaboratorSection theme={theme} onChange={() => handle('form')} credentials={user!} params={params} to="collaborator" />
            </TabsContent>
            <TabsContent value="form">
              <Card className={cn('relative w-full', theme === 'dark' ? 'bg-zinc-800' : 'bg-white')}>
                <FormCollaboratorSection id={id} theme={theme} onChange={() => handle('table')} to="collaborator" />
              </Card>
            </TabsContent>
          </Tabs>
        </main>
