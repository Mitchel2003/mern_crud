...
interface SolicitSectionProps extends ThemeContextProps { id: string | undefined, credentials: User }

const SolicitSection = ({ id, theme, credentials }: SolicitSectionProps) => {
        ...
        <TabsList className={cn(
          ...
          <TabsTrigger
            ...
            className={cn(
              'flex px-6 gap-2 items-center',
              'duration-200 hover:scale-105 hover:bg-accent/50',
              credentials?.role === 'company' && 'hidden'
            )}
          >
