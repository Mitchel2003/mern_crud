import { EngineerDashboardData } from "@/hooks/format/engineer/useEngineerDashboard"
...
interface UpcomingMaintenanceCardProps extends ThemeContextProps {
  maintenance: EngineerDashboardData['upcomingMaintenances'][0]
}
...
interface ActivityCardProps extends ThemeContextProps {
  activity: EngineerDashboardData['recentActivities'][0]
}
